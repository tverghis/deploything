...
pub enum Commands {
    ...
    Start {
        ...
        #[arg(short = 'p', long = "control-plane-port", default_value_t = 4040)]
        ...
        /// The port on which the agent should listen for incoming requests.
        #[arg(long = "proxy-port", default_value_t = 3000)]
        proxy_port: u16,
    },
}
